        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <table id="department-table" class="display pt-10">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Nama</th>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form id="department-form" data-form="create">
                        <!-- Name -->
                        <div class="pb-5">
        ...
        $(document).ready(function () {
            ...
            $('#department-form').submit(function (e) {
                ...
                if ($(this).attr('data-form') == 'create') {
                    var route = "{{ route('department.store') }}"
                    var method = "post"
                } else {
                    var route = "{{ route('department.update') }}"
                    var method = "patch"
                }
            ...
            $(document).on('click', '.edit-department',function () {
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    success: function (response) {
                        $('#id').val(response.department.id);
                        $('#name').val(response.department.nama);
                        $('#submit').html('Simpan');
                        $('#department-form').attr('data-form', 'edit');
                    },
                    error: function (response) {
                        Swal.fire({
                            title: 'Ooops',
            ...
            $('#cancel').on('click', function () {
                ...
                $('#name').val('');
                $('#submit').html('Tambah');
                $('#department-form').attr('data-form', 'create');
            });
        });
    </script>
@endpush    

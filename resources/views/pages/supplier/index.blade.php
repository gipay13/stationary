        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <table id="supplier-table" class="display pt-10">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Nama</th>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form id="supplier-form" data-form="create">
                        <!-- Name -->
                        <div class="pb-5">
                        ...
                        <div class="pb-5">
                            ...
                            <x-text-input id="address" class="block mt-1 w-full" type="text" name="address" required autocomplete="address" />
                        </div>

                        <!-- Telepon -->
                        <div class="pb-5">
                            <x-input-label for="phone" :value="__('Telepon')" />
                            <x-text-input id="phone" class="block mt-1 w-full" type="number" name="phone" required autocomplete="phone" />
                        </div>
        ...
        $(document).ready(function () {
            ...
            $('#supplier-form').submit(function (e) {
                ...
                if ($(this).attr('data-form') == 'create') {
                    var route = "{{ route('supplier.store') }}"
                    var method = "post"
                } else {
            ...
            $(document).on('click', '.edit-supplier',function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $('#name').val(response.supplier.nama);
                        $('#address').val(response.supplier.alamat);
                        $('#phone').val(response.supplier.telepon);
                        $('#submit').html('Simpan');
                        $('#supplier-form').attr('data-form', 'edit');
                    },
                    error: function (response) {
                        Swal.fire({
                            title: 'Ooops',
            ...
            $('#cancel').on('click', function () {
                ...
                $('#phone').val('');
                $('#submit').html('Tambah');
                $('#supplier-form').attr('data-form', 'create');
            });
        });
    </script>
@endpush
